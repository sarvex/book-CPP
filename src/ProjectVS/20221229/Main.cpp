...
* 
* 
* Задание 1: Разобраться с ссылками, const и constexpr, добавить их в свой калькулятор
* 
* Задание 2: Найти ошибку в этом коде, и добавить три алгоритма из библиотеки #include <algorithm>
*/
